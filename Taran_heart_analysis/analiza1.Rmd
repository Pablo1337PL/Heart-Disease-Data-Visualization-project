...
print(p)
  ...
  labs(title = "Death ratios for White and Black",
       ...
       y = "Ratio",
       color = "Race") +  # Label for legend
  scale_color_manual(values = c("White" = "#ffffff", "Black" = "#d85d4c")) +  # Manual color specification
  guides(color = guide_legend(
    override.aes = list(
      color = c("#d85d4c", "white")  # Changes "White" legend text color to gray, "Black" remains black
    )
  )) +
  theme(
